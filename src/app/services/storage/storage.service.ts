...
export class StorageService {
    ...
    uploadIconCategorie(file): Promise<string> {
        return new Promise((resolve, reject) => {
            this.uploadFile(file, 'Categories').then(
                url => {
                    resolve(url);
                }, err => reject(err)
    ...
    uploadProductsPictures(file,id ): Promise<string> {
        return new Promise((resolve, reject) => {

            this.uploadFiles(file,id, 'Products' ).then(
                url => {
                    resolve(url);
                }, err => reject(err)
            ).catch(err => reject(err));
    ...
    uploadProfilePicture(file): Promise<string> {
        return new Promise((resolve, reject) => {
            this.uploadFile(file, 'ProfilesImages').then(
                url => {
                    resolve(url);
                }, err => reject(err)
            ).catch(err => reject(err));
    ...
    uploadProfileLogoCompany(file): Promise<string> {
        return new Promise((resolve, reject) => {
            this.uploadFile(file, 'Logos').then(
                url => {
                    resolve(url);
                }, err => reject(err)
            ).catch(err => reject(err));
    ...
    uploadProfileCardPicture(file): Promise<string> {
        return new Promise((resolve, reject) => {
            this.uploadFile(file, 'CardsImages').then(
                url => {
                    resolve(url);
                }, err => reject(err)
            ).catch(err => reject(err));
